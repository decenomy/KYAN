    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  kyan-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Kyan in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 KYAN, 0.01 KYAN, 0.1 KYAN, 1 KYAN and 10 KYAN -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a href=\"https://docs.kyan.org/en/stable/wallets/kyancore/privatesend-instantsend.html\">PrivateSend documentation</a>."
        ));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
