...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (169669, uint256S("ece5ec203160de0b91842e319cc4dd5660e5adbbe4d0541fabb96bdc8289fb6b"))
    (339339, uint256S("e5d68479a10a9d1ede4638fac6523dcd58dec879fc2a2d73ecb86c344c65cc2a"))
    (509009, uint256S("c2c6a3b0ed9fd4091f4e8fb67ccdcfba7fdf92a1f8c1c691f810154462806927"))
    (678679, uint256S("de3eecfc95d12b4fc231ae483a603c6e28ee42f6dc9bf807a9f515fe09dcd325"))
    (848349, uint256S("f2d3f40231fcd46b86f1acf1b79e3b9d47563ef36ad504be7d50b52b10ca241b"))
    (1018019, uint256S("6faa8c962109566ec2bd4cd3bf322a61e6460849b340f59f16038dcecdb5ca1a"))
    (1187689, uint256S("ea6301128708ef77e2779a772bbcef9db8c7c14a7bac12b2c19e600e7c081281"))
    (1357359, uint256S("43595fed114bb51abe801fcb31989f10839677cbcfc6b100719f3e1bd85d49fb"))
    (1527029, uint256S("250ab167903b750aa338fd03576feda90e2974fd35e5ef3851db7f02e914fb75"))
 ;

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1721598600, // * UNIX timestamp of last checkpoint block
    3240675,    // * total number of transactions between genesis and last checkpoint
                //   (the tx=... number in the UpdateTip debug.log lines)
    2826        // * estimated number of transactions per day after checkpoint. 2000 for 10 minutes of bitcoin blockchain (1M block size). With 2M of block size and 1 minute of block time, this field should be around 4000 * 10 * 6 * 24 = 5760000
};
