...

{
    ...
    sph_jh512_init(&ctx_blake);
    sph_jh512 (&ctx_blake, (pbegin == pend ? pblank : static_cast<const void*>(&pbegin[0])), (pend - pbegin) * sizeof(pbegin[0]));
    sph_jh512_close(&ctx_blake, static_cast<void*>(&hash[0]));

    sph_bmw512_init(&ctx_bmw);
    sph_bmw512 (&ctx_bmw, static_cast<const void*>(&hash[0]), 64);
    sph_bmw512_close(&ctx_bmw, static_cast<void*>(&hash[1]));

    sph_echo512_init(&ctx_groestl);
    sph_echo512 (&ctx_groestl, static_cast<const void*>(&hash[1]), 64);
    sph_echo512_close(&ctx_groestl, static_cast<void*>(&hash[2]));
    ...
    sph_blake512 (&ctx_jh, static_cast<const void*>(&hash[3]), 64);
    sph_blake512_close(&ctx_jh, static_cast<void*>(&hash[4]));
    ...
    sph_skein512_init(&ctx_cubehash);
    sph_skein512 (&ctx_cubehash, static_cast<const void*>(&hash[6]), 64);
    sph_skein512_close(&ctx_cubehash, static_cast<void*>(&hash[7]));
