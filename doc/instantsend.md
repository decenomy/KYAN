...
This mechanism has been integrated into Bitcore-Node-Kyan which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/kyanpay/insight-api-kyan#web-socket-api](https://github.com/kyanpay/insight-api-kyan#web-socket-api)
* API: [https://github.com/kyanpay/insight-api-kyan#instantsend-transactions](https://github.com/kyanpay/insight-api-kyan#instantsend-transactions)
