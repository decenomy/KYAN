...
This document provides guidelines for internationalization of the Kyan Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `kyan_en.ts` remains unchanged.
