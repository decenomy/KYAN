...
Below are some notes on how to build Kyan Core for Windows.
...
way. This will install to `c:\workspace\kyan`, for example:

    make install DESTDIR=/mnt/c/workspace/kyan
