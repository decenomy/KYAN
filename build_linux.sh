...
# Create zip file of binaries
	cp KYAN/src/kyand KYAN/src/kyan-cli KYAN/src/kyan-tx KYAN/src/qt/kyan-qt .
	zip KYAN-Linux.zip kyand kyan-cli kyan-tx kyan-qt
	rm -f kyand kyan-cli kyan-tx kyan-qt
