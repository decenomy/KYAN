# Linearize
Construct a linear, no-fork, best version of the Kyan blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install kyan_hash

https://github.com/kyanpay/kyan_hash
...
JSON-RPC server. Running `kyand` or `kyan-qt -server` will be sufficient.
...
* `input`: kyand blocks/ directory containing blkNNNNN.dat
