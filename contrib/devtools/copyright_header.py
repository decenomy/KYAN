...
Arguments:
    <base_directory> - The base directory of a Kyan Core source code repository.
...
Arguments:
    <base_directory> - The base directory of Kyan Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Kyan Core repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Kyan
